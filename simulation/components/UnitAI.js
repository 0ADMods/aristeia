		...
		"HEAL": {
			...
			"HEALING": {
				"enter": function() {
                    ...
                    //warn('HEALING enter: cmpHeal: ' + cmpHeal + '  entity: '+ this.entity);
...
UnitAI.prototype.CanHeal = function(target)
{
    ...
    if (true || !(IsOwnedByPlayer(cmpOwnership.GetOwner(), target) || IsOwnedByAllyOfPlayer(cmpOwnership.GetOwner(), target)))
...
Engine.RegisterGlobal("UnitAI", UnitAI);
Engine.RegisterGlobal("UnitFsmSpec", UnitFsmSpec);
